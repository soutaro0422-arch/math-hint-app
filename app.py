    ...
    if img_file:
        with st.spinner("✨ AIが問題を解析しています。しばらくお待ちください..."):
            try:
                ...
                3. 図形問題における「辺AB」「角C」「三角形ABC」などの表現について、「ext=AB」や「text=AB」といったアルファベットの誤表示（LaTeXの \\text コマンドの崩れ）を絶対にしないでください。日本語で普通に「辺AB」とするか、数式にする場合でも「$AB$」や「辺 $AB$」のように、余計な英語コマンドを混ぜずにシンプルかつ綺麗に出力してください。
